...
<?php echo $this->Form->create('Transfert');?>
	<fieldset>
		<legend><?php echo __('Edit Transfert'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Transfert.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Transfert.id'))); ?></li>
